...
<!-- saved from url=(0036)http://www.byts.com.cn/users/reg.php -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script type="text/javascript" charset="utf-8" async="" src="home/user/crmqq.php"></script><script type="text/javascript" charset="utf-8" async="" src="home/user/contains.js"></script><script type="text/javascript" charset="utf-8" async="" src="home/user/localStorage.js"></script><script type="text/javascript" charset="utf-8" async="" src="home/user/Panel.js"></script>

<title>北京青年旅行社股份有限公司官网- 会员注册</title>
<link href="css/style.css" rel="stylesheet" media="screen" type="text/css">
<link href="css/common_wm.css" rel="stylesheet" media="screen" type="text/css">

<link href="css/reg-new.css" rel="stylesheet" media="screen" type="text/css">

<script language="javascript" src="js/reg_new.js"></script>
<script language="javascript" src="js/user_reg_jquery.js"></script>
...
<span>|</span>
<span><a href="./北京青年旅行社股份有限公司官网- 会员注册_files/北京青年旅行社股份有限公司官网- 会员注册.htm" target="_blank">注 册</a></span>
...
<div class="dh">
	<div class="conter">
   	  <div class="a1"><a href="http://www.byts.com.cn/users/reg.php#">所有目的地分类</a></div>
      <div class="a2">
      ...
      <div class="a3"><div style="position: absolute; left: 24px; top: 1px;"><img src="home/images/HOT.png"></div>
...
<!-- 验证使用的隐藏控件 -->
<input type="hidden" name="sub_username" id="sub_username" value="">
<input type="hidden" name="sub_nickname" id="sub_nickname" value="">
<input type="hidden" name="sub_tel" id="sub_tel" value="">
<input type="hidden" name="sub_email" id="sub_email" value="">
<input type="hidden" name="sub_identify" id="sub_identify" value=""> 
<input type="hidden" name="geturl" id="geturl" value="http://www.byts.com.cn">
          <form action="onregister" method="post" id="registerFrm" onsubmit="return false;">
            <input type="hidden" id="hidden" name="_token" value="{{csrf_token()}}" />
          <input type="hidden" name="dopost" id="dopost" value="dopost">  
<div class="top10">
<div id="user-reg">
    <div id="reg-wrap">
        <h1>欢迎注册为 北京青年旅行社股份有限公司官网 会员！</h1>

            <div id="reg-field">
                <ul class="input-list">
                    <li>
                        <div class="input">
                            <label for="username" class="">用户名：</label><input type="text" tabindex="1" name="name" id="username" onfocus="hide_note(&#39;user-tip&#39;);" onblur="check_username();" value="" style="ime-mode:disabled;" class="txt-m">
                        </div>
                        <div class="input-tip" id="user-tip"><div class="input-tip-inner"><p>必须为英文字母开头，5位以上英文字母、数字或下划线组成</p></div></div>
                    </li>
                    <li>
                        <div class="input">
                            <label for="nickname">真实姓名：</label><input type="text" tabindex="2" name="user" id="nickname" onfocus="hide_note(&#39;nick-tip&#39;);" onblur="check_nickname();" value="" class="txt-m">
                        </div>
                        <div class="input-tip" id="nick-tip"><div class="input-tip-inner"><p>必须为纯中文或纯英文，4位以上字符</p></div></div>
                    </li>
                    <li>
                        <div class="input">
                            <label for="mobile">手机号：</label><input type="text" tabindex="3" name="phone" id="tel" onfocus="hide_note(&#39;tel-tip&#39;);" onblur="check_tel();" style="ime-mode:disabled;" value="" class="txt-m">
                        </div>
                        <div class="input-tip" id="tel-tip"><div class="input-tip-inner"><p></p></div></div>
                    </li>
                    <li>

                        <div class="input">
                            <label for="email">邮箱：</label><input type="text" tabindex="4" name="email" id="email" onblur="check_email();" style="ime-mode:disabled;" value="" class="txt-m">
                        </div>
                        <div class="input-tip" id="email-tip"><div class="input-tip-inner"><p></p></div></div>
                    </li>
                    <li>
                        <div class="input">
                            <label for="password">密码：</label><input type="password" id="password" tabindex="5" name="pwd" style="ime-mode:disabled;" value="" class="txt-m" maxlength="16">
                        </div>
                        <div class="input-tip" id="password-tip"><div class="input-tip-inner"><p></p></div><div id="password-strength"><div id="password-strength-inner"></div></div><span id="rating-msg"></span></div>
                    </li>
                    <li>
                        <div class="input">
                            <label for="password-confirm">确认密码：</label><input type="password" tabindex="6" name="passwordagain" id="passwordagain" onblur="check_passwordagain();" style="ime-mode:disabled;" class="txt-m" value="">
                        </div>
                        <div class="input-tip" id="passwordagain-tip"><div class="input-tip-inner"><p></p></div></div>
                    </li>
                    <li>
                        <div class="input">
                            <label for="identify">验证码：</label><input type="text" tabindex="7" onblur="check_icode();" onfocus="hide_note(&#39;identify-tip&#39;);" id="identify_code" name="identify_code" style="ime-mode:disabled;" value="" class="txt-s">
                           <img id="vdimgck" align="absmiddle" onclick="this.src=this.src+&#39;?&#39;" style="cursor: pointer;" alt="看不清？点击更换" src="css/vdimgck.php"><br>
                           
                        </div>
                        <div class="input-tip" id="identify-tip"><div class="input-tip-inner"><p></p></div></div>

                    </li>
                    <li>
                        <div class="reg-check">
                            <input type="checkbox" id="travel-info" checked="checked"><label for="travel-info">愿意接受旅游资讯免费信息</label> <br>
                           <input tabindex="8" id="agreement" name="agreement" type="checkbox" checked="checked">我已阅读并接受<a href="http://www.byts.com.cn/add/v.php?aid=559" target="_blank" style=" color: #3D602B;text-decoration:none;">《注册协议》</a>
                           <span id="agree-tip" style="width:200px;height:39px;margin-left:35px;color:#f90"><span class="input-tip-inner"></span></span><br>
                        </div>
                    </li>
            ...
            <div id="reg-notice">
                您将拥有独一无二的会员卡号，可以使用您的会员卡号预订本站产品，获取积分，还能用积分抵扣现金，或者礼品哦！
            </div><!-- #reg notice -->
			
            <div class="sub-box">
<input type="image" tabindex="9" src="home/images/reg_sub.gif" name="info_submit" id="info_submit" 
onclick="try{ var s=s_gi(s_account);s.linkTrackVars=&#39;eVar25,events&#39;;s.linkTrackEvents=&#39;event15&#39;;s.events=&#39;event15&#39;
;s.eVar25=&#39;&#39;;s.tl(this,&#39;o&#39;,&#39;register&#39;);}catch(err){}info_submit()">
            <span id="submit_ing" style="color:#ff6600; position:relative; top:1px; display:none;">&nbsp;&nbsp;提交中 <img src="home/images/rbg.gif"></span>
            </div>
...
<!-- WPA Button Begin -->
<iframe width="121" height="277" scrolling="no" frameborder="0" allowtransparency="true" src="./北京青年旅行社股份有限公司官网- 会员注册_files/北京青年旅行社股份有限公司官网- 会员注册.htm" style="display: block; position: fixed; z-index: 2147483646 !important; left: auto; right: 8px; margin-left: 0px; top: 50%; bottom: auto; margin-top: -138px;"></iframe><script charset="utf-8" type="text/javascript" src="home/user/wpa.php"></script>
<!-- WPA Button End -->
...
jQuery.fn.passwordStrength = function(options) {
    ...
    $("#password-tip").append("<div id='password-strength'><div id='password-strength-inner'></div></div><span id='rating-msg'></span>");
    
    /*Observe Key Up event display password Strength rating*/
    $(this).live('keyup', function() {
        ...
        else if(level_score==1 && pass.length<=9){
        	rating=1;
        }else if(level_score==2 && pass.length<=9){
			rating=2;
		}else if(level_score==1 && pass.length>9){
			rating=2;
		}else if(level_score==2 && pass.length>9){
        ...
        $('#password-tip .input-tip-inner').hide();
        $('#password-strength').show();
        $('#password-strength-inner').css({"width":(rating/3)*160+"px"});
        $('#rating-msg').text(ratingMsgs[rating]).css({"color":ratingMsgColors[rating]});
        //记录密码强度值
        if(ratingMsgs[rating]=="弱"){
    	document.getElementById('pwd_s').value=1;
        }else if(ratingMsgs[rating]=="中"){
        document.getElementById('pwd_s').value=2;   
        }else if(ratingMsgs[rating]=="强"){
    ...
    $(this).live('blur', function() {
        ...
        if (psw === '') {
        	...
        	$('#password-tip').removeClass('ok');
			$('#password-tip').addClass('err');
        	$('#password-tip .input-tip-inner').html('<p>请输入6位以上的密码</p>');;
            $('#password-tip .input-tip-inner').show();
            $('#password-strength').hide();
            $('#rating-msg').empty();
        }

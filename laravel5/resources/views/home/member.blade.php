...
<div class="dh">
	<div class="conter">
   	  <div class="a1"><a href="http://www.byts.com.cn/users/#">所有目的地分类</a></div>
      <div class="a2">
...
<div class="de"><div class="lt"><a href="http://www.byts.com.cn/" style="margin-left:0px;">网站首页 &gt;</a>&nbsp;会员中心</div></div>
  ...
  <div class="top10">
     ...
     <div id="col">
        <div class="avatar-120"><a href="http://www.byts.com.cn/users"><img src="image/noface.jpg" width="75" height="75"></a></div>
        ...
        <ul id="user-nav">
            <li id="nav_left_1">
                <dl class="user-sub-nav cf">
                    <dd><a href="http://www.byts.com.cn/users/order.php?po=line">线路订单</a></dd>
                    <dd><a href="http://www.byts.com.cn/users/order.php?po=hotel">酒店订单</a></dd>
                    <dd><a href="http://www.byts.com.cn/users/order.php?po=tickets">门票订单</a></dd>
					 <dd><a href="http://www.byts.com.cn/users/order.php?po=qz">签证订单</a></dd>
					 <dd><a href="http://www.byts.com.cn/users/order.php?po=zuche">租车订单</a></dd>
                   
				   
                </dl>
                <a href="http://www.main.com" class="mlink">我的订单</a>
            </li>
            <li id="nav_left_2">
                <dl class="user-sub-nav cf">
            ...
            <li id="nav_left_3"><a href="http://www.byts.com.cn/users/order.php?po=dianping" class="mlink">我的点评</a></li>
            <li id="nav_left_4">
                <dl class="user-sub-nav cf">
               
			   
                    <dd><a href="http://www.byts.com.cn/users/index.php?do=edt">个人资料</a></dd>
					<dd><a href="http://www.byts.com.cn/users/index.php?do=change_face">修改头像</a></dd>
					<dd><a href="http://www.byts.com.cn/users/index.php?do=pwd">修改密码</a></dd>
					<dd><a href="http://www.byts.com.cn/users/edit_money.php">账户余额</a></dd>
                
				
                </dl>
                <a href="http://www.byts.com.cn/users/index.php?do=edt" class="mlink">账号管理</a>
            </li>
                    ...
                    <script>
                        ...
                        function InitNav()
                        {
                            $('#user-nav li').hover(function(){   
                                $(this).addClass('user-nav-over');
                            },function(){
                                $(this).removeClass('user-nav-over');
                            });
                        }
                        //scroll
                        $(function(){
                            ...
                            var btimes1 = 1;
                            $('#recommend-tab li').each(function(i){
                                $(this).bind('click',function(){
                                    $('#recommend-tab li').removeClass('recommend-tab-cur');
                                    $(this).addClass('recommend-tab-cur');
                                    $('.tui_scroll').hide();
                                    $('.tui_scroll').eq(i).show();
                                    if (i==1&&btimes1>0)
                                    {
                                        $("#crc-w2").tuiScrollLite({
                                            btnNext: ".t-next2",
                                            btnPrev: ".t-prev2",
                                            visible: 4
                                        });
            ...
            <div class="sy-main cf">
                <div class="sy-mainL">
                    <div class="dj-w">
                        <div class="head-pic">
                            <div class="avatar-75">
                                <img src="image/noface(1).jpg" alt="">
                            </div>
                            <a href="http://www.byts.com.cn/users/index.php?do=change_face" class="changeLink">修改头像</a>
                        </div>

                        <ul class="record-txt">
                            <li style="padding-bottom:10px;"><strong class="mcgreen f14">欢迎您！<b style="color: #FF6600">weisen</b></strong> 上一次登录时间：<span class="mcblue">2016-08-31 09:09:40</span></li>
                            <li>会员卡号：<strong class="mcblue f14">3839</strong></li>
                    ...
                    <div id="crc-w">
                        <ul class="common-rc2">
                            <div id="crc-w">
                                ...
                                <li><a href="http://www.byts.com.cn/line/beijiangkanasi002/3039.htm" class="cblue" target="_blank"><img src="image/140603150207.jpg" alt="">新疆喀纳斯经典双卧10日</a></li>
                 
										
                                <li><a href="http://www.byts.com.cn/line/beijiangkanasi002/3039.htm" class="cblue" target="_blank"><img src="image/140603150210.jpg" alt="">新疆喀纳斯经典双卧10日</a></li>
                 
										
                                <li><a href="http://www.byts.com.cn/line/beijiangkanasi002/3039.htm" class="cblue" target="_blank"><img src="image/140603150229.jpg" alt="">新疆喀纳斯经典双卧10日</a></li>
                 
										
                                <li><a href="http://www.byts.com.cn/line/beijiangkanasi002/3039.htm" class="cblue" target="_blank"><img src="image/140603150242.jpg" alt="">新疆喀纳斯经典双卧10日</a></li>
                 
										
                                <li><a href="http://www.byts.com.cn/line/beijiangkanasi002/1569.htm" class="cblue" target="_blank"><img src="image/140414151320.jpg" alt="">北疆喀纳斯经典双飞7日（三星可升级四星）</a></li>
...
<!-- WPA Button Begin -->
<iframe width="121" height="277" scrolling="no" frameborder="0" allowtransparency="true" src="./会员中心首页 - 北京青年旅行社股份有限公司官网_files/会员中心首页 - 北京青年旅行社股份有限公司官网.htm" style="display: block; position: fixed; z-index: 2147483646 !important; left: auto; right: 8px; margin-left: 0px; top: 50%; bottom: auto; margin-top: -138px;"></iframe><script charset="utf-8" type="text/javascript" src="./会员中心首页 - 北京青年旅行社股份有限公司官网_files/wpa.php"></script>
<!-- WPA Button End -->
<script language="JavaScript" src="./会员中心首页 - 北京青年旅行社股份有限公司官网_files/floatcard"></script><script src="js/all_20100501.js"></script><script id="TQGetrequestUser_JS"></script>

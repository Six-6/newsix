...
<div class="dh">
	<div class="conter">
   	  <div class="a1"><a href="http://www.byts.com.cn/users/index.php#">所有目的地分类</a></div>
      <div class="a2">
...
<div style="float:left; margin-left:5px;">
 <div id="content" style="width:1000px;height:450px;margin:15px auto 0 auto;position:relative;">
            ...
            <div id="login-box">
                ...
                <form action="http://www.byts.com.cn/users/index_do.php" method="post" id="loginFrm" onsubmit="return false;">
      ...
      <input type="hidden" name="gourl" value="">
                    ...
                    <div class="login-tab-content" id="login-tab-content0" style="width: 266px;">
                        <table class="login-table">
                            ...
                            <tr>
                                <th class="line3"></th>
                                <td class="cgrey2 line3"> <a target="_blank" href="http://www.byts.com.cn/users/resetpassword.php">找回密码</a> | <a target="_blank" href="http://www.byts.com.cn/users/reg.php">免费注册</a><br> &nbsp;</td>
                            </tr>
                        </tbody></table>

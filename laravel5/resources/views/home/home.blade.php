...
<!--出境旅游开始-->
	...
	<div class="newChannel clearfix">
		  <h2 class="travel-Hd">
		     <span class="travel-Hd-type travel-zb-type">{{$chu->r_region }}</span><span class="travel-Hd-msg"></span>
		  </h2>
  			<div class="newChannel-Bd cfix">
			    <div class="newHotel-left">
				     <div class="dest_classif_name">
				        <ul class="dcn_name clearfix">
				        @foreach($chu->child as $ass=>$chu2)
				           <li><a href="http://www.byts.com.cn/line/maerdaifu001" target="_blank" id="{{ $chu2->r_id }}" rel="nofollow">{{ $chu2->r_region }}</a></li>
						@endforeach                 
				        </ul>
			         </div>
                    ...
                    <div class="newHotel-right J-newChannel-right">
				        ...
				        @foreach($chu->child as $ats=>$chu3)
				           <li id="{{ $chu3->r_id }}">{{ $chu3->r_region }}</li>
						@endforeach     
                        </ul>                        
